...
@section('content_header')
    <h1><b>Editar daltos del padre de familia seleccionado</b></h1>
    <hr>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    <form action="{{url('admin/ppffs/' . $ppffs->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('nombres', $ppffs->nombres) }}" name="nombres"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('apellidos', $ppffs->apellidos) }}" name="apellidos"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" class="form-control"
                                                    value="{{ old('fecha_nacimiento', $ppffs->fecha_nacimiento) }}" name="fecha_nacimiento"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('telefono', $ppffs->telefono) }}" name="telefono"
                                                    placeholder="Escriba aqui.." required>
                                            </div>
                                            @error('telefono')
                                                <small style="color: red"> {{ $message }}</small>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('parentesco', $ppffs->parentesco) }}" name="parentesco"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('ocupacion', $ppffs->ocupacion) }}" name="ocupacion"
                                                    placeholder="Escriba aqui.." required>
                                            </div>
                                            @error('ocupacion')
                                                <small style="color: red"> {{ $message }}</small>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('direccion', $ppffs->direccion) }}" name="direccion"
                                                    placeholder="Escriba aqui.." required>
                                            </div>
                                            @error('direccion')
                                                <small style="color: red"> {{ $message }}</small>
