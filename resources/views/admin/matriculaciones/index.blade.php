        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Estudiantes con matriculacion registrados</h3>
                        ...
                        <table id="example" class="table table-bordered table-striped table-hover table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Fecha de matriculacion</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text">
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('/admin/matriculaciones/' . $matriculacion->id) }}"
                                                    method="POST" id="miFormulario{{ $matriculacion->id }}">
                                                    @csrf
                                                    @method('DELETE')
