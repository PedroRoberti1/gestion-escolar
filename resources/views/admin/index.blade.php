...
@section('content')
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box zoomP">
                <img src="{{ url('/img/materias.gif') }}" width="70px">
                <div class="info-box-content">
                    <span class="info-box-text"><b>Materias registradas</b></span>
                    <span class="info-box-number" style="color: brown; font-size:15pt">{{ $total_materias }}
                        materias</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box zoomP">
                <img src="{{ url('/img/roles.gif') }}" width="70px">
                <div class="info-box-content">
                    <span class="info-box-text"><b>Roles registrados</b></span>
                    <span class="info-box-number" style="color: brown; font-size:15pt">{{ $total_roles }}
                        rol</span>
                </div>
            </div>
        </div>
