...
@section('content_header')
    <h1><b>Editar Formacion del personal</b></h1>
    <hr>
@stop
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="archivo"
                                                ...
                                                accept="image/*">
                                            <br>
                                            <img id="preview" src="{{url($formacion->archivo)}}" alt="Vista previa"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('titulo', $formacion->titulo) }}" name="titulo"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ old('institucion', $formacion->institucion) }}" name="institucion"
                                                    placeholder="Escriba aqui.." required>
                                            </div>
                                            @error('institucion')
                                                <small style="color: red"> {{ $message }}</small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" class="form-control" id="fecha_graduacion"
                                                    value="{{ old('nombre', $formacion->fecha_graduacion) }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-succes"> <i
